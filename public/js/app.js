...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'app-navbar': _layout_Navbar_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    'app-footer': _layout_Footer_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  ...
  methods: {
    fetchCart: function fetchCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/cart/' + this.token).then(function (response) {
        _this.carts = response.data.data; // console.log(this.carts)
      })["catch"](function (error) {
        console.log(error);
      });
    },
    remove: function remove(productId, index) {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_2___default.a["delete"]('/api/cart/' + productId).then(function (response) {
    ...
    totalPrice: function totalPrice(quantity, price) {
      var total = parseInt(quantity) * parseInt(price);
      return (total / 1).toFixed(2);
    },
    minusAmount: function minusAmount(cartId, productId, quantity, price) {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/cart/minAmount', {
        'cartId': cartId,
        'productId': productId,
        'quantity': quantity,
        'price': price
        ...
        _this3.fetchTotal(); // console.log(response)

      })["catch"](function (error) {
        console.log(error);
      });
    },
    plusAmount: function plusAmount(cartId, productId, quantity, price) {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/cart/plusAmount', {
        'cartId': cartId,
        'productId': productId,
        'quantity': quantity,
        'price': price
        ...
        _this4.fetchTotal(); // console.log(response)
    ...
    fetchTotal: function fetchTotal() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/cart/price/' + this.token).then(function (response) {
        // console.log(response)
        _this5.total = response.data.total; // console.log(this.total);
      })["catch"](function (error) {
        console.log(error);
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/checkout/' + this.token).then(function (response) {
      _this.data.user = response.data.data;
  ...
  methods: {
    order: function order() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/order', this.data).then(function (response) {
        // console.log(response.data.message)
        if (response.data.message == "success") {
          _this2.$router.push('/thank');
        }
      })["catch"](function (error) {
        console.log(error);
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _layout_Footer_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./layout/Footer.vue */ "./resources/js/components/layout/Footer.vue");
/* harmony import */ var _layout_Navbar_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./layout/Navbar.vue */ "./resources/js/components/layout/Navbar.vue");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'app-navbar': _layout_Navbar_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    'app-footer': _layout_Footer_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  methods: {
    fetchProduct: function fetchProduct(url) {
      var _this = this;

      var page_url = url || '/api/product';
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(page_url).then(function (response) {
        // console.log(response);
    ...
    latest: function latest() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/product/latest').then(function (response) {
        // console.log(response)
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/ShopSingle.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/ShopSingle.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/product/' + id).then(function (response) {
      _this.data.product = response.data.data;
  ...
  methods: {
    ...
    addCart: function addCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/cart', this.data).then(function (response) {
        console.log(response);
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Thank.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Thank.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductCreate.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin/ProductCreate.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    imageFile: function imageFile(event) {
      this.picture = event.target.files[0];
      console.log(this.picture);
    },
    createProduct: function createProduct() {
      var uploadImage = new FormData();
      uploadImage.set('picture', this.picture); // console.log(this.picture)

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/product', uploadImage).then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductEdit.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin/ProductEdit.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    editProduct: function editProduct() {
      ...
      var id = this.$route.params.id;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.put('/api/product/' + id, this.data).then(function (response) {
        console.log(response);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/login', this.data).then(function (response) {
        if (response.data.message == "Success") {
          localStorage.setItem('token', response.data.token);
          localStorage.setItem('admin', response.data.is_admin); // alert('success')
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    register: function register() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/register', this.data).then(function (response) {
        // console.log(response)
        localStorage.setItem('token', response.data.token);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/user/' + this.token).then(function (response) {
      ...
      _c("div", { staticClass: "site-section" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row mb-5" }, [
            _c(
              "form",
              { staticClass: "col-md-12", attrs: { method: "post" } },
              [
                _c("div", { staticClass: "site-blocks-table" }, [
                  _c("table", { staticClass: "table table-bordered" }, [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.carts, function(cart, index) {
                        return _c("tr", { key: cart.cartsId }, [
                          _c("td", { staticClass: "product-thumbnail" }, [
                            _c("img", {
                              staticClass: "img-fluid",
                              attrs: {
                                src: "./images/" + cart.picture,
                                alt: "Image"
                              }
                            })
                          ]),
                          ...
                          _c("td", { staticClass: "product-name" }, [
                            _c("h2", { staticClass: "h5 text-black" }, [
                          ...
                          _vm._v(" "),
                          _c("td", [
                            _vm._v("$" + _vm._s(_vm.formatPrice(cart.total)))
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.remove(cart.productId, index)
                                  }
                                }
                              },
                              [_vm._v("X")]
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "bg-light py-3" }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            _c("a", { attrs: { href: "index.html" } }, [_vm._v("Home")]),
            _vm._v(" "),
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Cart")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "product-thumbnail" }, [_vm._v("Image")]),
        _vm._v(" "),
        _c("th", { staticClass: "product-name" }, [_vm._v("Product")]),
        _vm._v(" "),
        _c("th", { staticClass: "product-price" }, [_vm._v("Price")]),
        _vm._v(" "),
        _c("th", { staticClass: "product-quantity" }, [_vm._v("Quantity")]),
        _vm._v(" "),
        _c("th", { staticClass: "product-total" }, [_vm._v("Total")]),
        _vm._v(" "),
        _c("th", { staticClass: "product-remove" }, [_vm._v("Remove")])
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-md-6 mb-3 mb-md-0" }, [
  ...
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "col-md-8 mb-3 mb-md-0" }, [
        _c("input", {
          staticClass: "form-control py-3",
          attrs: { type: "text", id: "coupon", placeholder: "Coupon Code" }
        })
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-12 text-right border-bottom mb-5" }, [
        _c("h3", { staticClass: "text-black h4 text-uppercase" }, [
          _vm._v("Cart Totals")
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-md-6" }, [
      _c("span", { staticClass: "text-black" }, [_vm._v("Subtotal")])
    ])
  },
  function() {
    var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "site-section" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-6 mb-5 mb-md-0" }, [
              _c("h2", { staticClass: "h3 mb-3 text-black" }, [
                _vm._v("Billing Details")
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "p-3 p-lg-5 border" }, [
                _c("div", { staticClass: "form-group row" }, [
                  _c("div", { staticClass: "col-md-12" }, [
                    ...
                    _c("input", {
                      ...
                      attrs: { type: "text", id: "c_fname", name: "c_fname" },
                ...
                _c("div", { staticClass: "form-group row" }, [
                  _c("div", { staticClass: "col-md-12" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.data.detail.address,
                          expression: "data.detail.address"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.data.detail.address },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                ...
                _c("div", { staticClass: "form-group row" }, [
                  _c("div", { staticClass: "col-md-6" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.data.detail.country,
                          expression: "data.detail.country"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.data.detail.country },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.data.detail.post_code,
                          expression: "data.detail.post_code"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.data.detail.post_code },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                ...
                _c("div", { staticClass: "form-group row mb-5" }, [
                  _c("div", { staticClass: "col-md-12" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.data.detail.phone,
                          expression: "data.detail.phone"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.data.detail.phone },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("textarea", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.data.detail.order_note,
                        expression: "data.detail.order_note"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                    ...
                    domProps: { value: _vm.data.detail.order_note },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.data.detail.payment_method,
                              expression: "data.detail.payment_method"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { id: "c_diff_country" },
                          on: {
                        ...
                        [
                          _c("option", { attrs: { value: "transfer" } }, [
                            _vm._v("Direct Bank Transfer")
                          ]),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "cheque" } }, [
                            _vm._v("Cheque Payment")
                          ]),
                          _vm._v(" "),
...
var staticRenderFns = [
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            ...
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("a", { attrs: { href: "cart.html" } }, [_vm._v("Cart")]),
            _vm._v(" "),
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Checkout")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_fname" } },
      [
        _vm._v("Username "),
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_email_address" } },
      [
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_address" } },
      [
        _vm._v("Address "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_postal_zip" } },
      [
        _vm._v("Posta / Zip "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_phone" } },
      [
        _vm._v("Phone "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
    ...
    return _c("div", { staticClass: "row mb-5" }, [
      _c("div", { staticClass: "col-md-12" }, [
        ...
        _c("div", { staticClass: "p-3 p-lg-5 border" }, [
          _c(
            "label",
            { staticClass: "text-black mb-3", attrs: { for: "c_code" } },
            [_vm._v("Enter your coupon code if you have one")]
          ),
          _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("table", { staticClass: "table site-block-order-table mb-5" }, [
      _c("thead", [
      ...
      _c("tbody", [
        _c("tr", [
          _c("td", [
            _vm._v("Top Up T-Shirt "),
            _c("strong", { staticClass: "mx-2" }, [_vm._v("x")]),
            _vm._v(" 1")
          ]),
          _vm._v(" "),
          _c("td", [_vm._v("$250.00")])
        ...
        _vm._v(" "),
        _c("tr", [
          _c("td", { staticClass: "text-black font-weight-bold" }, [
            _c("strong", [_vm._v("Cart Subtotal")])
          ]),
          _vm._v(" "),
          _c("td", { staticClass: "text-black" }, [_vm._v("$350.00")])
        ]),
        _vm._v(" "),
        _c("tr", [
          _c("td", { staticClass: "text-black font-weight-bold" }, [
            _c("strong", [_vm._v("Order Total")])
          ]),
          _vm._v(" "),
          _c("td", { staticClass: "text-black font-weight-bold" }, [
            _c("strong", [_vm._v("$350.00")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "border p-3 mb-3" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "collapse", attrs: { id: "collapsebank" } }, [
  ...
  function() {
    ...
    return _c("div", { staticClass: "border p-3 mb-3" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "collapse", attrs: { id: "collapsecheque" } }, [
        _c("div", { staticClass: "py-2" }, [
          _c("p", { staticClass: "mb-0" }, [
            _vm._v(
              "Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won’t be shipped until the funds have cleared in our account."
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "border p-3 mb-5" }, [
      _c("h3", { staticClass: "h6 mb-0" }, [
        _c(
          "a",
          {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "collapse", attrs: { id: "collapsepaypal" } }, [
        _c("div", { staticClass: "py-2" }, [
          _c("p", { staticClass: "mb-0" }, [
            _vm._v(
              "Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won’t be shipped until the funds have cleared in our account."
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "site-section" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row mb-5" }, [
            _c("div", { staticClass: "col-md-9 order-2" }, [
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col-md-12 mb-5" }, [
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _c("router-link", { attrs: { to: "/" } }, [
                                _c("a", [_vm._v("Welcome Admin!")])
                              ])
                            ],
                            1
                          ),
                          _vm._v(" "),
                          _c("p", [_vm._v("Make a new Product here!")]),
                          _vm._v(" "),
                          _c("router-link", { attrs: { to: "/create" } }, [
                            _c(
                              ...
                              {
                                staticClass:
                                  "btn btn-primary btn-sm mb-5 text-white"
                              },
                              [_vm._v("Add Product")]
                            )
                          ])
                  ...
                  _c("div", { staticClass: "d-flex" }, [
                    _c("div", { staticClass: "dropdown mr-1 ml-md-auto" }, [
                      _c(
                        "button",
                        {
                          staticClass:
              ...
              _c(
                ...
                _vm._l(_vm.products, function(product, index) {
                  return _c(
                    ...
                    {
                      key: product.id,
                      staticClass: "col-sm-6 col-lg-4 mb-4",
                      attrs: { "data-aos": "fade-up" }
                    },
                    [
                      _c("div", { staticClass: "block-4 text-center border" }, [
                        _c(
                          "figure",
                          { staticClass: "block-4-image" },
                          [
                            _c(
                              "router-link",
                              {
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "block-4-text p-4" }, [
                          _c(
                            "h3",
                            [
                              _c(
                          ...
                          ? _c(
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "btn btn-warning btn-sm mr-2 mb-4 text-white"
                                      },
                                      [_vm._v("Edit")]
                                    )
                                  ]
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "btn btn-danger btn-sm mb-4 text-white",
                                    on: {
                                      click: function($event) {
                                        $event.preventDefault()
              ...
              _c(
                "div",
                { staticClass: "row", attrs: { "data-aos": "fade-up" } },
                [
                          ...
                          _vm._l(_vm.pagination.last_page, function(n) {
                            return _c(
                              "li",
                              {
                                key: n,
                                class: {
                                  active: n == _vm.pagination.current_page
                                },
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.fetchProduct(
                                      _vm.pagination.path + n
                                    )
                                  }
                                }
                              },
                              [
                                _c("span", { staticClass: "pointerClass" }, [
                                  _vm._v(_vm._s(n))
                                ])
                              ]
                            )
...
var staticRenderFns = [
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            ...
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Shop")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "float-md-left mb-4" }, [
      _c("h2", { staticClass: "text-black h5" }, [_vm._v("Shop All")])
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c("div", { staticClass: "btn-group" }, [
      ...
      _c(
        ...
        {
          staticClass: "dropdown-menu",
          attrs: { "aria-labelledby": "dropdownMenuReference" }
        },
        [
          _c("a", { staticClass: "dropdown-item", attrs: { href: "#" } }, [
            _vm._v("Relevance")
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-md-3 order-1 mb-5 mb-md-0" }, [
      _c("div", { staticClass: "border p-4 rounded mb-4" }, [
        _c("h3", { staticClass: "mb-3 h6 text-uppercase text-black d-block" }, [
          _vm._v("Categories")
        ]),
        _vm._v(" "),
        _c("ul", { staticClass: "list-unstyled mb-0" }, [
          _c("li", { staticClass: "mb-1" }, [
            _c("a", { staticClass: "d-flex", attrs: { href: "#" } }, [
              _c("span", [_vm._v("Men")]),
              _vm._v(" "),
              _c("span", { staticClass: "text-black ml-auto" }, [
                _vm._v("(2,220)")
              ])
            ])
          ]),
      ...
      _c("div", { staticClass: "border p-4 rounded mb-4" }, [
        _c("div", { staticClass: "mb-4" }, [
          _c(
            "h3",
            { staticClass: "mb-3 h6 text-uppercase text-black d-block" },
          ...
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control border-0 pl-0 bg-white",
            attrs: { type: "text", name: "text", id: "amount", disabled: "" }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "mb-4" }, [
          ...
          _vm._v(" "),
          _c("label", { staticClass: "d-flex", attrs: { for: "s_sm" } }, [
            _c("input", {
              staticClass: "mr-2 mt-1",
              attrs: { type: "checkbox", id: "s_sm" }
            }),
            _vm._v(" "),
            _c("span", { staticClass: "text-black" }, [_vm._v("Small (2,319)")])
          ]),
          _vm._v(" "),
          _c("label", { staticClass: "d-flex", attrs: { for: "s_md" } }, [
            _c("input", {
              staticClass: "mr-2 mt-1",
              attrs: { type: "checkbox", id: "s_md" }
            }),
            _vm._v(" "),
          ...
          _vm._v(" "),
          _c("label", { staticClass: "d-flex", attrs: { for: "s_lg" } }, [
            _c("input", {
              staticClass: "mr-2 mt-1",
              attrs: { type: "checkbox", id: "s_lg" }
            }),
            _vm._v(" "),
            _c("span", { staticClass: "text-black" }, [_vm._v("Large (1,392)")])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "mb-4" }, [
          ...
          _c(
            "a",
            {
              staticClass: "d-flex color-item align-items-center",
              attrs: { href: "#" }
            },
            [
              _c("span", {
                staticClass:
                  "bg-danger color d-inline-block rounded-circle mr-2"
              }),
              _vm._v(" "),
              _c("span", { staticClass: "text-black" }, [_vm._v("Red (2,429)")])
            ]
          ),
          _vm._v(" "),
          _c(
            ...
            [
              _c("span", {
                staticClass:
                  "bg-success color d-inline-block rounded-circle mr-2"
              }),
              _vm._v(" "),
              _c("span", { staticClass: "text-black" }, [
                _vm._v("Green (2,298)")
          ...
          _c(
            ...
            [
              _c("span", {
                staticClass: "bg-info color d-inline-block rounded-circle mr-2"
              }),
              _vm._v(" "),
              _c("span", { staticClass: "text-black" }, [
                _vm._v("Blue (1,075)")
          ...
          _c(
            ...
            [
              _c("span", {
                staticClass:
                  "bg-primary color d-inline-block rounded-circle mr-2"
              }),
              _vm._v(" "),
              _c("span", { staticClass: "text-black" }, [
                _vm._v("Purple (1,075)")
  ...
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "site-section site-blocks-2" }, [
          _c(
            "div",
            { staticClass: "row justify-content-center text-center mb-5" },
            [
              _c("div", { staticClass: "col-md-7 site-section-heading pt-4" }, [
          ...
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              {
                ...
                attrs: { "data-aos": "fade", "data-aos-delay": "" }
              },
              [
                _c("a", { staticClass: "block-2-item", attrs: { href: "#" } }, [
                  _c("figure", { staticClass: "image" }, [
                    _c("img", {
                      staticClass: "img-fluid",
                      attrs: { src: "images/women.jpg", alt: "" }
                    })
                  ]),
                  _vm._v(" "),
            ...
            _c(
              "div",
              {
                staticClass: "col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0",
              ...
              [
                _c("a", { staticClass: "block-2-item", attrs: { href: "#" } }, [
                  _c("figure", { staticClass: "image" }, [
                    _c("img", {
                      staticClass: "img-fluid",
                      attrs: { src: "images/children.jpg", alt: "" }
                    })
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "text" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889& ***!
  \*************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("app-navbar"),
      _vm._v(" "),
      _c("div", { staticClass: "bg-light py-3" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              ...
              [
                ...
                _vm._v(" "),
                _c("strong", { staticClass: "text-black" }, [
                  _vm._v(_vm._s(_vm.data.product.name))
                ])
              ],
              1
            )
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-6" }, [
              _c("img", {
                ...
                attrs: {
                  src:
                    "http://localhost:8000/images/" + _vm.data.product.picture,
                  alt: "Image"
                }
              })
            ]),
            ...
            _c("div", { staticClass: "col-md-6" }, [
              ...
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.data.product.description))]),
              _vm._v(" "),
              _c("p", [
                _c("strong", { staticClass: "text-primary h4" }, [
                  _vm._v("$" + _vm._s(_vm.data.product.price))
                ])
              ]),
              _vm._v(" "),
                  ...
                  [
                    _c(
                      "span",
                      {
                        ...
                        staticStyle: { top: "-2px", position: "relative" }
                      },
                      [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.data.data.size,
                              expression: "data.data.size"
                            }
                          ],
                          attrs: {
                            type: "radio",
                          ...
                          domProps: {
                            checked: _vm._q(_vm.data.data.size, "small")
                          },
                          on: {
                            change: function($event) {
                              return _vm.$set(_vm.data.data, "size", "small")
                            }
                          }
                        })
                      ]
                    ...
                    _vm._v(" "),
                    _c("span", { staticClass: "d-inline-block text-black" }, [
                      _vm._v("Small")
                    ])
                  ]
                ),
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          domProps: {
                            checked: _vm._q(_vm.data.data.size, "medium")
                          },
                          on: {
                            change: function($event) {
                              return _vm.$set(_vm.data.data, "size", "medium")
                            }
                          }
                        })
                      ]
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          domProps: {
                            checked: _vm._q(_vm.data.data.size, "large")
                          },
                          on: {
                            change: function($event) {
                              return _vm.$set(_vm.data.data, "size", "large")
                            }
                          }
                        })
                      ]
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          domProps: {
                            checked: _vm._q(_vm.data.data.size, "extra_large")
                          },
                          on: {
                            change: function($event) {
                              return _vm.$set(
                ...
                _c(
                  ...
                  [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.data.data.quantity,
                          expression: "data.data.quantity"
                        }
                      ],
                      staticClass: "form-control text-center",
                      attrs: {
                      ...
                      domProps: { value: _vm.data.data.quantity },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
              ...
              _c(
                "button",
                {
                  staticClass: "buy-now btn btn-sm btn-primary",
                  on: {
                    click: function($event) {
                      $event.preventDefault()
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "site-section block-3 site-blocks-2 bg-light" },
      [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row justify-content-center" }, [
            _c(
              "div",
              { staticClass: "col-md-7 site-section-heading text-center pt-4" },
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-12" }, [
              _c("div", { staticClass: "nonloop-block-3 owl-carousel" }, [
                _c("div", { staticClass: "item" }, [
                  _c("div", { staticClass: "block-4 text-center" }, [
                    _c("figure", { staticClass: "block-4-image" }, [
                      _c("img", {
                        staticClass: "img-fluid",
                        attrs: {
                          src: "http://localhost:8000/images/cloth_1.jpg",
                          alt: "Image placeholder"
                        }
                      })
                    ]),
                    ...
                    _c("div", { staticClass: "block-4-text p-4" }, [
                      _c("h3", [
                        _c("a", { attrs: { href: "#" } }, [_vm._v("Tank Top")])
                      ]),
                      _vm._v(" "),
                      _c("p", { staticClass: "mb-0" }, [
                        _vm._v("Finding perfect t-shirt")
                      ]),
                      _vm._v(" "),
                      _c(
                        "p",
                  ...
                  _c("div", { staticClass: "block-4 text-center" }, [
                    _c("figure", { staticClass: "block-4-image" }, [
                      _c("img", {
                        staticClass: "img-fluid",
                        attrs: {
                          src: "http://localhost:8000/images/shoe_1.jpg",
                          alt: "Image placeholder"
                        }
                      })
                    ]),
                    ...
                    _c("div", { staticClass: "block-4-text p-4" }, [
                      _c("h3", [
                        _c("a", { attrs: { href: "#" } }, [_vm._v("Corater")])
                      ]),
                      _vm._v(" "),
                      _c("p", { staticClass: "mb-0" }, [
                        _vm._v("Finding perfect products")
                      ]),
                      _vm._v(" "),
                      _c(
                        "p",
                  ...
                  _c("div", { staticClass: "block-4 text-center" }, [
                    _c("figure", { staticClass: "block-4-image" }, [
                      _c("img", {
                        staticClass: "img-fluid",
                        attrs: {
                          src: "http://localhost:8000/images/cloth_2.jpg",
                          alt: "Image placeholder"
                        }
                      })
                    ]),
                  ...
                  _c("div", { staticClass: "block-4 text-center" }, [
                    _c("figure", { staticClass: "block-4-image" }, [
                      _c("img", {
                        staticClass: "img-fluid",
                        attrs: {
                          src: "http://localhost:8000/images/cloth_3.jpg",
                          alt: "Image placeholder"
                        }
                      })
                    ]),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f& ***!
  \********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row" }, [
            _c(
              ...
              [
                _c("span", {
                  staticClass: "icon-check_circle display-3 text-success"
                }),
                _vm._v(" "),
                _c("h2", { staticClass: "display-3 text-black" }, [
                  _vm._v("Thank you!")
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "lead mb-5" }, [
                  _vm._v("You order was successfuly completed.")
                ]),
                _vm._v(" "),
                _c("router-link", { attrs: { to: "/", tag: "p" } }, [
                  _c("a", { staticClass: "btn btn-sm btn-primary" }, [
                    _vm._v("Back to shop")
                  ])
                ])
              ],
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            ...
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Contact")])
          ])
        ])
      ])
    ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470& ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
                ...
                _c("div", { staticClass: "col-md-12" }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", { attrs: { value: "men" } }, [_vm._v("Men")])
                    ]
                  )
                ])
              ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-md-12" }, [
      _c("h2", { staticClass: "h3 mb-5 text-black text-center mb-5" }, [
        _vm._v("Add Product ")
      ])
    ])
  },
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_name" } },
      [
        _vm._v("Name "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_price" } },
      [
        _vm._v("Price "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_image" } },
      [
        _vm._v("Image "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_color" } },
      [
        _vm._v("Color "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_description" } },
      [
        _vm._v("Description "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_category" } },
      [
        _vm._v("Category "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e& ***!
  \********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var staticRenderFns = [
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            ...
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Login")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-md-12" }, [
      _c("h2", { staticClass: "h3 mb-3 text-black text-center" }, [
        _vm._v("Login")
      ])
    ])
  },
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_email" } },
      [
        _vm._v("Email "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
  ...
  function() {
    ...
    return _c(
      "label",
      { staticClass: "text-black", attrs: { for: "c_password" } },
      [
        _vm._v("Password "),
        _c("span", { staticClass: "text-danger" }, [_vm._v("*")])
      ]
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-md-12 mb-0" }, [
            ...
            _c("span", { staticClass: "mx-2 mb-0" }, [_vm._v("/")]),
            _vm._v(" "),
            _c("strong", { staticClass: "text-black" }, [_vm._v("Register")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group row" }, [
      _c("div", { staticClass: "col-lg-12" }, [
        _c("input", {
          staticClass: "btn btn-primary btn-lg btn-block",
          attrs: { type: "submit", value: "Register Now" }
        })
      ])
    ])
  }
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("footer", { staticClass: "site-footer border-top" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "row" }, [
                ...
                _c("div", { staticClass: "col-md-6 col-lg-4" }, [
                  _c("ul", { staticClass: "list-unstyled" }, [
                    _c("li", [
                      _c("a", { attrs: { href: "#" } }, [_vm._v("Sell online")])
                    ]),
                    _vm._v(" "),
                    _c("li", [
                ...
                _c("div", { staticClass: "col-md-6 col-lg-4" }, [
                  _c("ul", { staticClass: "list-unstyled" }, [
                    ...
                    _vm._v(" "),
                    _c("li", [
                      _c("a", { attrs: { href: "#" } }, [_vm._v("Hardware")])
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c("a", { attrs: { href: "#" } }, [_vm._v("Software")])
                    ])
                  ])
                ])
              ])
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col-md-6 col-lg-3 mb-4 mb-lg-0" }, [
              _c("h3", { staticClass: "footer-heading mb-4" }, [
                _vm._v("Promo")
              ]),
              _vm._v(" "),
              _c("a", { staticClass: "block-6", attrs: { href: "#" } }, [
                _c("img", {
                  staticClass: "img-fluid rounded mb-4",
                  attrs: {
                    src: "http://localhost:8000/images/hero_1.jpg",
                    alt: "Image placeholder"
                  }
                }),
                _vm._v(" "),
                _c("h3", { staticClass: "font-weight-light  mb-0" }, [
                  _vm._v("Finding Your Perfect Shoes")
                ]),
                _vm._v(" "),
                _c("p", [_vm._v("Promo from  nuary 15 — 25, 2019")])
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "col-md-6 col-lg-3" }, [
              _c("div", { staticClass: "block-5 mb-5" }, [
                _c("h3", { staticClass: "footer-heading mb-4" }, [
                  _vm._v("Contact Info")
                ]),
                _vm._v(" "),
                _c("ul", { staticClass: "list-unstyled" }, [
                  ...
                  _c("li", { staticClass: "phone" }, [
                    _c("a", { attrs: { href: "tel://23923929210" } }, [
                      _vm._v("+2 392 3929 210")
                    ])
                  ]),
                  _vm._v(" "),
                  _c("li", { staticClass: "email" }, [
                    _vm._v("emailaddress@domain.com")
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "block-7" }, [
                _c("form", { attrs: { action: "#", method: "post" } }, [
                  _c(
                    "label",
                    {
                      staticClass: "footer-heading",
                      attrs: { for: "email_subscribe" }
                    },
                    [_vm._v("Subscribe")]
                  ),
                  _vm._v(" "),
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("header", { staticClass: "site-navbar", attrs: { role: "banner" } }, [
      _c("div", { staticClass: "site-navbar-top" }, [
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row align-items-center" }, [
            ...
            _c(
              "div",
              { staticClass: "col-6 col-md-4 order-3 order-md-3 text-right" },
              [
                _c("div", { staticClass: "site-top-icons" }, [
                  _c(
                    "ul",
                    [
                      _vm.token == null
      ...
      _c(
        "nav",
        {
          staticClass: "site-navigation text-right text-md-center",
        ...
        [
          _c("div", { staticClass: "container" }, [
            _c(
              "ul",
              { staticClass: "site-menu js-clone-nav d-none d-md-block" },
              [
                _vm._m(5),
                _vm._v(" "),
                _vm._m(6),
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "col-6 col-md-4 order-2 order-md-1 site-search-icon text-left"
      },
      [
        _c(
          "form",
          { staticClass: "site-block-top-search", attrs: { action: "" } },
          [
            _c("span", { staticClass: "icon icon-search2" }),
            _vm._v(" "),
            _c("input", {
  ...
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center"
      },
      [
        _c("div", { staticClass: "site-logo" }, [
          _c(
            "a",
            { staticClass: "js-logo-clone", attrs: { href: "index.html" } },
            [_vm._v("Shoppers")]
          )
        ])
      ]
  ...
  function() {
    ...
    return _c("li", [
      _c("a", { attrs: { href: "#" } }, [
        _c("span", { staticClass: "icon icon-heart-o" })
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("li", [
      _c("a", { staticClass: "site-cart", attrs: { href: "cart.html" } }, [
        _c("span", { staticClass: "icon icon-shopping_cart" }),
        _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "d-inline-block d-md-none ml-md-0" }, [
      _c(
        "a",
        {
  ...
  function() {
    ...
    return _c("li", { staticClass: "has-children" }, [
      ...
      _c("ul", { staticClass: "dropdown" }, [
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Menu One")])]),
        _vm._v(" "),
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Menu Two")])]),
        _vm._v(" "),
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Menu Three")])]),
        _vm._v(" "),
        _c("li", { staticClass: "has-children" }, [
          _c("a", { attrs: { href: "#" } }, [_vm._v("Sub Menu")]),
          _vm._v(" "),
          _c("ul", { staticClass: "dropdown" }, [
            _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Menu One")])]),
            _vm._v(" "),
            ...
            _vm._v(" "),
            _c("li", [
              _c("a", { attrs: { href: "#" } }, [_vm._v("Menu Three")])
            ])
          ])
        ])
      ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Catalogue")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
/***/ "./resources/js/components/ShopSingle.vue":
/*!************************************************!*\
  !*** ./resources/js/components/ShopSingle.vue ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ShopSingle.vue?vue&type=template&id=0ed9c889& */ "./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889&");
/* harmony import */ var _ShopSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ShopSingle.vue?vue&type=script&lang=js& */ "./resources/js/components/ShopSingle.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _ShopSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/ShopSingle.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/ShopSingle.vue?vue&type=script&lang=js&":
/*!*************************************************************************!*\
  !*** ./resources/js/components/ShopSingle.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ShopSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./ShopSingle.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/ShopSingle.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ShopSingle_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889&":
/*!*******************************************************************************!*\
  !*** ./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889& ***!
  \*******************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./ShopSingle.vue?vue&type=template&id=0ed9c889& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/ShopSingle.vue?vue&type=template&id=0ed9c889&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShopSingle_vue_vue_type_template_id_0ed9c889___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/Thank.vue":
/*!*******************************************!*\
  !*** ./resources/js/components/Thank.vue ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Thank.vue?vue&type=template&id=01d05a8f& */ "./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f&");
/* harmony import */ var _Thank_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Thank.vue?vue&type=script&lang=js& */ "./resources/js/components/Thank.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Thank.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Thank.vue?vue&type=script&lang=js&":
/*!********************************************************************!*\
  !*** ./resources/js/components/Thank.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Thank_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Thank.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Thank.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Thank_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f&":
/*!**************************************************************************!*\
  !*** ./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f& ***!
  \**************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Thank.vue?vue&type=template&id=01d05a8f& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Thank.vue?vue&type=template&id=01d05a8f&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Thank_vue_vue_type_template_id_01d05a8f___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/admin/ProductCreate.vue":
/*!*********************************************************!*\
  !*** ./resources/js/components/admin/ProductCreate.vue ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProductCreate.vue?vue&type=template&id=2e980470& */ "./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470&");
/* harmony import */ var _ProductCreate_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProductCreate.vue?vue&type=script&lang=js& */ "./resources/js/components/admin/ProductCreate.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/admin/ProductCreate.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/admin/ProductCreate.vue?vue&type=script&lang=js&":
/*!**********************************************************************************!*\
  !*** ./resources/js/components/admin/ProductCreate.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470&":
/*!****************************************************************************************!*\
  !*** ./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470& ***!
  \****************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./ProductCreate.vue?vue&type=template&id=2e980470& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductCreate.vue?vue&type=template&id=2e980470&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductCreate_vue_vue_type_template_id_2e980470___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/admin/ProductEdit.vue":
/*!*******************************************************!*\
  !*** ./resources/js/components/admin/ProductEdit.vue ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProductEdit.vue?vue&type=template&id=28c6a17e& */ "./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e&");
/* harmony import */ var _ProductEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProductEdit.vue?vue&type=script&lang=js& */ "./resources/js/components/admin/ProductEdit.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/admin/ProductEdit.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/admin/ProductEdit.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/components/admin/ProductEdit.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e& ***!
  \**************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./ProductEdit.vue?vue&type=template&id=28c6a17e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin/ProductEdit.vue?vue&type=template&id=28c6a17e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductEdit_vue_vue_type_template_id_28c6a17e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _components_Shop_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Shop.vue */ "./resources/js/components/Shop.vue");
/* harmony import */ var _components_ShopSingle_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/ShopSingle.vue */ "./resources/js/components/ShopSingle.vue");
...
/* harmony import */ var _components_Checkout_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/Checkout.vue */ "./resources/js/components/Checkout.vue");
/* harmony import */ var _components_Thank_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/Thank.vue */ "./resources/js/components/Thank.vue");
/* harmony import */ var _components_admin_ProductCreate_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/admin/ProductCreate.vue */ "./resources/js/components/admin/ProductCreate.vue");
/* harmony import */ var _components_admin_ProductEdit_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/admin/ProductEdit.vue */ "./resources/js/components/admin/ProductEdit.vue");
...
var routes = [{
  ...
  path: '/',
  component: _components_Shop_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
  meta: {
    requiresAuth: true
  }
}, {
  path: '/single/:id',
  component: _components_ShopSingle_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
  name: 'single',
  meta: {
    requiresAuth: true
  }
  ...
  path: '/checkout',
  component: _components_Checkout_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
  meta: {
    requiresAuth: true
  }
}, {
  path: '/thank',
  component: _components_Thank_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
  meta: {
    requiresAuth: true
  }
}, {
  path: '/create',
  component: _components_admin_ProductCreate_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
  meta: {
    requiresAuth: true,
    is_admin: true
  }
  ...
  path: '/edit/:id',
  component: _components_admin_ProductEdit_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
  name: 'edit',
  meta: {
    requiresAuth: true,
    is_admin: true
...
__webpack_require__(/*! D:\Kelas 11\Administrasi Sistem Jaringan\Laravel\laravelVueShop\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Kelas 11\Administrasi Sistem Jaringan\Laravel\laravelVueShop\resources\sass\app.scss */"./resources/sass/app.scss");
